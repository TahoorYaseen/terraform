...
func _() {
	...
	_ = x[CheckAssertion-4]
	_ = x[CheckDataSource-5]
}

const _CheckRuleType_name = "InvalidConditionResourcePreconditionResourcePostconditionOutputPreconditionCheckAssertionCheckDataSource"

var _CheckRuleType_index = [...]uint8{0, 16, 36, 57, 75, 89, 104}
